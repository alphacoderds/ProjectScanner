...
//         Uri.parse(
//             'http://192.168.9.138/ProjectScanner/lib/API/update_keterangan.php?no=${widget.selectedProject['id_lot']}'),
//       );
...
//         Uri.parse(
//             'http://192.168.9.138/ProjectScanner/lib/API/update_keterangan.php'),
//         body: {
