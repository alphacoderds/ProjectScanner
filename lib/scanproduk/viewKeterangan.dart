...
//         Uri.parse(
//             'http://192.168.10.102/ProjectScanner/lib/API/update_keterangan.php?no=${widget.selectedProject['id_lot']}'),
//       );
...
//         Uri.parse(
//             'http://192.168.10.102/ProjectScanner/lib/API/update_keterangan.php'),
//         body: {
...
//         dynamic dataStep = jsonData['step'];
