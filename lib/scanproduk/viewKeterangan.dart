...
//         Uri.parse(
//             'http://10.208.204.53/ProjectScanner/lib/API/update_keterangan.php?no=${widget.selectedProject['id_lot']}'),
//       );
...
//         Uri.parse(
//             'http://10.208.204.53/ProjectScanner/lib/API/update_keterangan.php'),
//         body: {
