  ...
  Future<void> _fetchData() async {
    try {
      final response = await http.get(Uri.parse(
          'http://192.168.8.26/ProjectScanner/lib/tahapselesai/read_openlist.php?id_openlist=${widget.id_openlist}'));
  ...
  void _deleteOpenItem(String id) async {
    try {
      final response = await http.post(
        Uri.parse(
          'http://192.168.8.26/ProjectScanner/lib/tahapselesai/delete_openlist.php',
        ),
        body: {
          'no': id,
        },
